...
function minio() {
    local src="$DIR/addons/minio/2022-11-11T03-44-20Z"
    ...
    if [ -n "$minio_ha_exists" ]; then
        ...
        kubectl set image -n minio statefulset/ha-minio minio=minio/minio:RELEASE.2022-11-11T03-44-20Z
        ...
        kubectl set image -n minio deployment/minio minio=minio/minio:RELEASE.2022-11-11T03-44-20Z 2>/dev/null || true
    else
